		...
		<div class="row">
			<div class="col-md-2">
				<div class="list-group">
				    ...
				    <a
						href="${pageContext.request.contextPath}/jsp/add_student.jsp" class="list-group-item">添加学生</a>
						<a
						href="${pageContext.request.contextPath}/jsp/Search_student.jsp" class="list-group-item active">查询学生</a>
				</div>
			</div>
			<div class="col-md-10">
				...
				<form id="searchForm" action="${pageContext.request.contextPath}/students?method=searchByCondition" method="post" class="form_border">
					<input type="hidden" name="pageIndex" id="pageIndex" />
					<div class="form-group">
	                        <label>姓名</label>
	                        <input type="text" name="name" value="${searchCondition.name}" class="form-control"/>
	                </div>
	                <div class="form-group">
	                        <label>年龄</label>
	                        <input type="text" name="age" value="${searchCondition.age}" class="form-control"/>
	                </div>
	                <div class="form-group">
						<label>性别</label> 
